...
namespace UserRegistrationUsingLambda
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("**1.Check User FirstName For E.g Abcdeggh**");
            Console.WriteLine("**2.Check User LastName For E.g Anmopqrs**");
            Console.WriteLine("**3.Check User Valid Email, For E.g abcde.abcdefg@xyz");
            Console.WriteLine("**4.Check User Name With Country Code E.g 91 9635648273");
